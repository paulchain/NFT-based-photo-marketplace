  ...
  onSubmit(event) {
    ...
    ipfs.files.add(this.state.buffer, (error, result) => {
      ...
      photoNFTFactory.methods
        .createNewPhotoNFT(nftName, nftSymbol, photoPrice, ipfsHashOfPhoto)
        ...
        .once('receipt', (receipt) => {
          ...
          photoNFT.methods
            .ownerOf(photoId)
            .call()
            .then((owner) => console.log('=== owner of photoId 1 ===', owner))
          ...
          photoNFT.methods
            ...
            .once('receipt', (receipt) => {
              ...
              photoNFTMarketplace.methods
                .openTradeWhenCreateNewPhotoNFT(PHOTO_NFT, photoId, photoPrice)
                .send({ from: accounts[0] })
                .once('receipt', (receipt) => {})
            })
        })
    ...
    return (
      <div className={styles.left}>
        <Grid container style={{ marginTop: 20 }}>
          <Grid item xs={10}>
            <Card width={'420px'} maxWidth={'420px'} mx={'auto'} my={5} p={20} borderColor={'#E8E8E8'}>
